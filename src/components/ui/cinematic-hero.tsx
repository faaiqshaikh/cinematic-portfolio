    ...
    >
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none" style={{ perspective: "1500px" }}>
        ...
        >
          ...
          <div
            id="about"
            className="relative w-full h-full max-w-6xl mx-auto px-5 md:px-12 flex flex-col lg:grid lg:grid-cols-2 items-center gap-6 md:gap-12 lg:gap-16 z-10 py-8 md:py-12 overflow-y-auto lg:overflow-visible custom-scrollbar"
          >
            ...
            <div className="card-right-text relative w-full max-w-md mx-auto lg:ml-auto group/card">
              ...
              <div className="relative z-10 w-full h-[500px] md:h-[700px] flex items-center justify-center transition-all duration-500">
