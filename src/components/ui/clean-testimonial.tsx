...
const testimonials = [
  {
    quote: "Faiq's ability to translate complex prototypes into functional UI is exceptional. He brought a new level of precision to our design systems.",
    author: "Sarah Chen",
    role: "Design Lead",
  ...
  {
    quote: "Finally, someone who understands that simplicity is the ultimate sophistication. Delivered a pixel-perfect landing page in record time.",
    author: "Marcus Webb",
  ...
  {
    quote: "Mohammedfaiq's approach to mobile-first thinking and dedicated bug fixing transformed our event portal into a seamless experience.",
    author: "Elena Frost",
